            ...
            <a href="./film.php?id=<?= $film['id'] ?>" class="card-movie__link">
                <div class="card-movie">
                    ...
                    <div class="card-info">
                        ...
                        <h4 class="<?php if ($film['vote_average'] >= 7) { echo "green";} else if ($film['vote_average'] < 8 && $film['vote_average'] >= 5) {echo "orange";} else if ($film['vote_average'] == "-") {echo "";} else { echo "red";} ?>"><?= $film['vote_average'] ?></h4>
                    </div>
                </div>
            </a>
        <?php } ?>
...
?>
    ...
    <script src="views/script/carousel.js"></script>
</body>
</html>
